...
class RecipiesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_recipies, container, false).apply {
            val recyclerView: RecyclerView = findViewById(R.id.recycerbreakfast)
            ...
            val recyclerView1: RecyclerView = findViewById(R.id.recycerbreaklunch)
            recyclerView1.layoutManager = LinearLayoutManager(requireActivity(), LinearLayoutManager.HORIZONTAL, false)
            recyclerView1.adapter = RecipiesAdapter()

            val recyclerView2: RecyclerView = findViewById(R.id.recycerbreakdinner)
            recyclerView2.layoutManager = LinearLayoutManager(requireActivity(), LinearLayoutManager.HORIZONTAL, false)
            recyclerView2.adapter = RecipiesAdapter()

            val recyclerView3: RecyclerView = findViewById(R.id.recycersnack)
            recyclerView3.layoutManager = LinearLayoutManager(requireActivity(), LinearLayoutManager.HORIZONTAL, false)
            recyclerView3.adapter = RecipiesAdapter()
