package com.amirsohelsapplication.app.modules.registrationformthree.ui
...
class SpinnerCountryAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerCountryModel>
) : ArrayAdapter<SpinnerCountryModel>(mContext, layoutResource, allItems) {
